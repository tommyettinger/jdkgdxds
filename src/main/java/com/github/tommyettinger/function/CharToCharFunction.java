...
public interface CharToCharFunction {
	 ...
	 * @see #andThen(CharToCharFunction)
	 */
	default CharToCharFunction compose (CharToCharFunction before) {
	 ...
	 * @see #compose(CharToCharFunction)
	 */
	default CharToCharFunction andThen (CharToCharFunction after) {
