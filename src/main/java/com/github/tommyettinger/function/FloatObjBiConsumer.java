...
/**
 * Represents an operation that accepts a {@code float}-valued and an
 * object-valued argument, and returns no result.  This is the
 * {@code (float, reference)} specialization of {@link BiConsumer}.
 * Unlike most other functional interfaces, {@code FloatObjBiConsumer} is
 ...
 */
@FunctionalInterface
public interface FloatObjBiConsumer<U> {
