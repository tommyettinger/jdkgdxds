 ...
 * to {@link IntList} as long as the performance of {@link #get(int)} is adequate.
...
public class IntDeque extends IntList implements RandomAccess, Arrangeable, PrimitiveCollection.OfInt, Ordered.OfInt {
	...
	public void addLast(int value1, int value2, int value3, int value4, int value5) {
		int[] items = this.items;
	...
	public void addLast(int value1, int value2, int value3, int value4, int value5, int value6) {
		int[] items = this.items;
	...
	public void addFirst(int value1, int value2, int value3, int value4, int value5) {
		int[] items = this.items;
	...
	public IntListIterator listIterator() {
		return new IntDequeIterator(this);
	}
	...
	public IntListIterator listIterator(int index) {
		return new IntDequeIterator(this, index, false);
	}
	 ...
	 *
	 * @param filter an IntPredicate (takes an int and returns true if it should be removed); may be a lambda
	...
	public IntListIterator descendingIterator() {
		return new IntDequeIterator(this, true);
	}
	...
	public IntListIterator descendingIterator(int index) {
		return new IntDequeIterator(this, index, true);
	}
