...
public class ObjectIntOrderedMap<K> extends ObjectIntMap<K> implements Ordered<K> {
	 ...
	 */
	public void putAll (ObjectIntOrderedMap<? extends K> map, int start, int end) {
	 ...
	 * method is called. Use the {@link OrderedMapKeys#OrderedMapKeys(ObjectIntOrderedMap)}
	 ...
	 * {@link OrderedMapValues#OrderedMapValues(ObjectIntOrderedMap)} constructor for nested or multithreaded iteration.
	 *
	 ...
	 * Use the {@link OrderedMapEntries#OrderedMapEntries(ObjectIntOrderedMap)} constructor for nested or multithreaded iteration.
	 *
	 ...
	 * {@link OrderedMapEntries#OrderedMapEntries(ObjectIntOrderedMap)} if you need nested or
	 * multithreaded iteration. You can remove an Entry from this ObjectIntOrderedMap
	 * using this Iterator.
	 *
