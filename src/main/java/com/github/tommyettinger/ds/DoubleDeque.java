...
public class DoubleDeque extends DoubleList implements RandomAccess, Arrangeable, PrimitiveCollection.OfDouble, Ordered.OfDouble {
	...
	public void addLast(double value1, double value2, double value3, double value4, double value5) {
		double[] items = this.items;
	...
	public void addLast(double value1, double value2, double value3, double value4, double value5, double value6) {
		double[] items = this.items;
	...
	public void addFirst(double value1, double value2, double value3, double value4, double value5) {
		double[] items = this.items;
