...
public class ObjectObjectOrderedMap<K, V> extends ObjectObjectMap<K, V> implements Ordered<K> {
	...
	private void resetTo(ObjectObjectOrderedMap<? extends K, ? extends V> map) {
	 ...
	 * You can remove an Entry from this ObjectObjectOrderedMap using this Iterator.
	 *
	...
	/**
	 * Appends to an Appendable CharSequence from the contents of this ObjectObjectOrderedMap, but uses the given {@link Appender}s
