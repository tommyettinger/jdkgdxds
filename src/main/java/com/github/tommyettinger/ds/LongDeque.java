...
public class LongDeque implements PrimitiveCollection.OfLong, Arrangeable {
	...
	public static class LongDequeIterator implements PrimitiveIterator.OfLong {
		...
		/**
		 * Returns an iterator over elements of type {@code long}. Allows this to be used like an {@link Iterable}.
		 *
		 * @return this same LongDequeIterator.
		 */
		public LongDeque.LongDequeIterator iterator () {
			return this;
		}
	}
