...
public class CharDeque extends CharList implements RandomAccess, Arrangeable, PrimitiveCollection.OfChar,
	...
	public void addLast(char value1, char value2, char value3, char value4, char value5) {
		char[] items = this.items;
	...
	public void addLast(char value1, char value2, char value3, char value4, char value5, char value6) {
		char[] items = this.items;
	...
	public void addFirst(char value1, char value2, char value3, char value4, char value5) {
		char[] items = this.items;
	...
	public void addFirst(char value1, char value2, char value3, char value4, char value5,
	                     char value6, char value7, char value8) {
		char[] items = this.items;
	...
	public CharListIterator listIterator() {
		return new CharDequeIterator(this);
	}
	...
	public CharListIterator listIterator(int index) {
		return new CharDequeIterator(this, index, false);
	}
	 ...
	 * <br>
	 * This can be used to perform tasks like converting the case of a CharDeque that contains letters, with
	 ...
	 *
	 * @return a new {@link CharIterator} over this deque
	 */
	...
	public CharListIterator descendingIterator() {
		return new CharDequeIterator(this, true);
	}
	...
	public CharListIterator descendingIterator(int index) {
		return new CharDequeIterator(this, index, true);
	}
	...
	/**
	 * Sorts this deque in-place using {@link Arrays#sort(char[], int, int)} in ascending order.
	 */
	@Override
	public void sort() {
		sort(0, size);
	...
	/**
	 * Uses {@link Arrays#sort(char[], int, int)} to sort a (clamped) subrange of this deque.
	 *
	...
	public void sort(int from, int to, CharComparator comparator) {
		...
		if (comparator == null) {
			...
			CharComparators.sort(items, head + from - items.length, head + to - items.length, comparator);
		} else {
			trimToSize(); // rearranges items so it is linear starting at 0
