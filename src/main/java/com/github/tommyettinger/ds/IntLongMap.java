...
public class IntLongMap implements Iterable<IntLongMap.Entry> {
	 ...
	 * {@link Base#appendReadable(CharSequence, int)} and {@link Base#appendUnsigned(CharSequence, long)}. To use
	...
	/**
	 * Appends to an Appendable CharSequence from the contents of this IntLongMap. Uses
	 * {@link IntAppender#DEFAULT} and {@link LongAppender#DEFAULT} to write keys and values, and appends them
	...
	public <S extends CharSequence & Appendable> S appendTo(S sb, String entrySeparator, boolean braces) {
		return appendTo(sb, entrySeparator, "=", braces, IntAppender.DEFAULT, LongAppender.DEFAULT);
	}

	/**
	 * Appends to an Appendable CharSequence from the contents of this IntLongMap, but uses the given {@link IntAppender} and
	 * {@link LongAppender} to convert each key and each value to a customizable representation and append them
	 * to {@code sb}. These functions are often method references to methods in Base, such as
	 * {@link Base#appendReadable(CharSequence, int)} and {@link Base#appendUnsigned(CharSequence, int)}. To use
	 * the default String representation, you can use {@link IntAppender#DEFAULT} or {@link LongAppender#DEFAULT}
	...
	public static class Entries extends AbstractSet<Entry> implements EnhancedCollection<Entry> {
		...
		/**
		 * Append the remaining items that this can iterate through into the given IntLongMap.
		 * Does not change the position of this iterator.
		 *
		 * @param map a modifiable IntLongMap; may have items appended into it
	...
	public static class Keys implements PrimitiveSet.SetOfInt {
		...
		public boolean equals(Object other) {
			return SetOfInt.super.equalContents(other);
		}
	 ...
	 */
	public static IntLongMap with(Number key0, Number value0, Number key1, Number value1) {
		IntLongMap map = new IntLongMap(2);
		map.put(key0.intValue(), value0.longValue());
	 ...
	 * @return a new map containing the given key-value pairs
	 */
	public static IntLongMap with(Number key0, Number value0, Number key1, Number value1, Number key2, Number value2) {
		IntLongMap map = new IntLongMap(3);
		map.put(key0.intValue(), value0.longValue());
		map.put(key1.intValue(), value1.longValue());
	 ...
	 * @return a new map containing the given key-value pairs
	 */
	public static IntLongMap with(Number key0, Number value0, Number key1, Number value1, Number key2, Number value2, Number key3, Number value3) {
		IntLongMap map = new IntLongMap(4);
		map.put(key0.intValue(), value0.longValue());
		map.put(key1.intValue(), value1.longValue());
		map.put(key2.intValue(), value2.longValue());
	 ...
	 * of boxed Number, such as {@link Integer} or {@link Double}, and will be converted to primitive {@code int}s and
	 * {@code long}s.
	 * <br>
			...
			for (int i = 1; i < pairs.length; i += 2) {
				try {
					if (pairs[i - 1] != null && pairs[i] != null)
						put(pairs[i - 1].intValue(), pairs[i].longValue());
	...
	/**
	 * Adds items to this map drawn from the result of {@link #toString(String)} or
	 * {@link #appendTo(CharSequence, String, String, boolean, IntAppender, LongAppender)}. Each item can vary
	 ...
	 * @return a new map containing nothing
	 */
	public static IntLongMap withPrimitive() {
		return new IntLongMap(0);
	}
	 ...
	 * @return a new map containing just the entry mapping key0 to value0
	 */
	public static IntLongMap withPrimitive(int key0, long value0) {
		IntLongMap map = new IntLongMap(1);
		map.put(key0, value0);
		return map;
	}
	 ...
	 * @return a new map containing the given key-value pairs
	 */
	public static IntLongMap withPrimitive(int key0, long value0, int key1, long value1) {
		IntLongMap map = new IntLongMap(2);
		map.put(key0, value0);
		map.put(key1, value1);
		return map;
	 ...
	 * @return a new map containing the given key-value pairs
	 */
	public static IntLongMap withPrimitive(int key0, long value0, int key1, long value1, int key2, long value2) {
		IntLongMap map = new IntLongMap(3);
		map.put(key0, value0);
		map.put(key1, value1);
		map.put(key2, value2);
	 ...
	 * @return a new map containing the given key-value pairs
	 */
	public static IntLongMap withPrimitive(int key0, long value0, int key1, long value1, int key2, long value2, int key3, long value3) {
		IntLongMap map = new IntLongMap(4);
		map.put(key0, value0);
		map.put(key1, value1);
		map.put(key2, value2);
