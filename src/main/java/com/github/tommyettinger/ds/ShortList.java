...
public class ShortList implements PrimitiveCollection.OfShort, Ordered.OfShort, Arrangeable, RandomAccess {
	 ...
	 *
	 * @param c a primitive collection of short items to remove fully, such as another ShortList or a ShortDeque
	 ...
	 *
	 * @param c a primitive collection of short items to remove one-by-one, such as another ShortList or a ShortDeque
	 * @return true if this list was modified.
	 */
	...
	/**
	 * Sorts this entire collection using {@link Arrays#sort(short[], int, int)} in ascending order.
	 */
	public void sort() {
	...
	/**
	 * Uses {@link Arrays#sort(short[], int, int)} to sort a (clamped) subrange of this collection in ascending order.
	 *
