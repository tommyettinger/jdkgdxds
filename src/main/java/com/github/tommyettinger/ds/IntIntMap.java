...
public class IntIntMap implements Iterable<IntIntMap.Entry> {
	...
	private void resetTo(IntIntMap map) {
	...
	/**
	 * Makes a String from the contents of this IntIntMap, but uses the given {@link IntAppender}
	...
	/**
	 * Appends to an Appendable CharSequence from the contents of this IntIntMap. Uses
	 * {@link IntAppender#DEFAULT} to write keys and values, and appends them
	...
	/**
	 * Appends to an Appendable CharSequence from the contents of this IntIntMap, but uses the given {@link IntAppender}s
	 * to convert each key and each value to a customizable representation and append them
	 * to {@code sb}. These functions are often method references to methods in Base, such as
	 * {@link Base#appendReadable(CharSequence, int)} and {@link Base#appendUnsigned(CharSequence, int)}. To use
	 * the default String representation, you can use {@link IntAppender#DEFAULT}
	...
	public static class Entries extends AbstractSet<Entry> implements EnhancedCollection<Entry> {
		...
		/**
		 * Append the remaining items that this can iterate through into the given IntIntMap.
		 * Does not change the position of this iterator.
		 *
		 * @param map a modifiable IntIntMap; may have items appended into it
		 * @return the given map
		 */
		public IntIntMap appendInto(IntIntMap map) {
			EntryIterator iter = iterator();
			while (iter.hasNext) {
