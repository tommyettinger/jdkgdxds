...
import static com.github.tommyettinger.ds.x.Collections.dummy;
...
public class ObjectMapX<K, V> implements Map<K, V>, Iterable<Map.Entry<K, V>>, Serializable {
	...
	public @Nullable V get (@NotNull Object key, @Nullable V defaultValue) {
		int i = locateKey(key);
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ObjectMapX)) return false;
		ObjectMapX other = (ObjectMapX)obj;
	...
	static protected abstract class MapIterator<K, V, I> implements Iterable<I>, Iterator<I> {
		...
		protected final ObjectMapX<K, V> map;
		protected int nextIndex, currentIndex;
		protected boolean valid = true;

		public MapIterator (ObjectMapX<K, V> map) {
			this.map = map;
			reset();
		}
	...
	static public class Entries<K, V> extends AbstractSet<Map.Entry<K, V>> {
		...
		public Entries (ObjectMapX<K, V> map) {
	...
	static public class Values<V> extends AbstractCollection<V> {
		...
		protected Values(){}
		public Values (ObjectMapX<?, V> map) {
			iter = new MapIterator<Object, V, V>((ObjectMapX<Object, V>) map) {
				@Override
				public @NotNull Iterator<V> iterator() {
					return this;
				}
	...
	static public class Keys<K> extends AbstractSet<K> {
		...
		protected Keys(){}
		public Keys (ObjectMapX<K, ?> map) {
			iter = new MapIterator<K, Object, K>((ObjectMapX<K, Object>) map) {
				@Override
