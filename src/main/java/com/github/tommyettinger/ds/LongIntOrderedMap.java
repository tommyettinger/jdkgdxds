...
public class LongIntOrderedMap extends LongIntMap implements Ordered.OfLong {
	...
	private void resetTo(LongIntOrderedMap map) {
	...
	/**
	 * Appends to an Appendable CharSequence from the contents of this LongIntOrderedMap, but uses the given {@link LongAppender} and
