...
public class IdentitySet<T> extends ObjectSet<T> {
	 ...
	 * @return a new collection parsed from str
	 */
	public static <T> IdentitySet<T> withLegible(String str, String delimiter, PartialParser<T> parser, boolean brackets) {
	 ...
	 * @return a new collection parsed from str
	 */
	public static <T> IdentitySet<T> withLegible(String str, String delimiter, PartialParser<T> parser, int offset, int length) {
		IdentitySet<T> c = new IdentitySet<>();
