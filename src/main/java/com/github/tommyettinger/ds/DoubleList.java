...
public class DoubleList implements PrimitiveCollection.OfDouble, Ordered.OfDouble, Arrangeable {
	 ...
	 *
	 * @param filter a DoublePredicate (takes a double and returns true if it should be removed); may be a lambda
	 ...
	 *
	 * @param other a PrimitiveCollection.OfDouble that contains the items that this should keep, whenever present
