 ...
 * to {@link ByteList} as long as the performance of {@link #get(int)} is adequate. Because it is array-backed, it
...
public class ByteDeque extends ByteList implements RandomAccess, Arrangeable, PrimitiveCollection.OfByte, Ordered.OfByte {
	 ...
	 */
	public static ByteDeque withLegible(String str, String delimiter) {
	 ...
	 * @return a new collection parsed from str
	 */
	public static ByteDeque withLegible(String str, String delimiter, boolean brackets) {
	 ...
	 * @return a new collection parsed from str
	 */
	public static ByteDeque withLegible(String str, String delimiter, int offset, int length) {
		ByteDeque c = new ByteDeque();
