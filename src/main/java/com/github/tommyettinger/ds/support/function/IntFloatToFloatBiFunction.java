...
/**
 * Represents a function that accepts a {@code int} argument and a {@code float}
 * argument, and produces a float-valued result.  This is the {@code (int, float)},
 * {@code float}-producing primitive specialization for {@link BiFunction}.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #applyAsFloat(int, float)}.
 *
 * @see BiFunction
 */
@FunctionalInterface
