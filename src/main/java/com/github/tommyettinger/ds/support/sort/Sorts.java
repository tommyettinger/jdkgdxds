 ...
 * of a stable, in-place {@linkplain #sort(int, int, IntComparator, Arrangeable) mergesort}.
 */
...
public class Sorts {
	 ...
	 */
	public static void sort (final int from, final int to, final IntComparator c, final Arrangeable swapper) {
		/*
		...
		int mid = from + to >>> 1;
		sort(from, mid, c, swapper);
		sort(mid, to, c, swapper);
