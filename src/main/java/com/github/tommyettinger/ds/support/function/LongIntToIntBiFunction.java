...
/**
 * Represents a function that accepts a {@code long} argument and a {@code int}
 * argument, and produces a int-valued result.  This is the {@code (long, int)},
 * {@code int}-producing primitive specialization for {@link BiFunction}.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #applyAsInt(long, int)}.
 *
 * @see BiFunction
 */
@FunctionalInterface
