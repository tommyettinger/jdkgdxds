...
public class Base {
    ...
    public long[] longSplit(String source, String delimiter, int startIndex, int endIndex) {
        if(delimiter.length() == 0 || endIndex <= startIndex || startIndex < 0 || startIndex >= source.length()) return new long[0];
    ...
    public int[] intSplit(String source, String delimiter, int startIndex, int endIndex) {
        if(delimiter.length() == 0 || endIndex <= startIndex || startIndex < 0 || startIndex >= source.length()) return new int[0];
        int amount = count(source, delimiter, startIndex, endIndex);
    ...
    public short[] shortSplit(String source, String delimiter, int startIndex, int endIndex) {
        if(delimiter.length() == 0 || endIndex <= startIndex || startIndex < 0 || startIndex >= source.length()) return new short[0];
        int amount = count(source, delimiter, startIndex, endIndex);
    ...
    public byte[] byteSplit(String source, String delimiter, int startIndex, int endIndex) {
        if(delimiter.length() == 0 || endIndex <= startIndex || startIndex < 0 || startIndex >= source.length()) return new byte[0];
        int amount = count(source, delimiter, startIndex, endIndex);
    ...
    public char[] charSplit(String source, String delimiter, int startIndex, int endIndex) {
        if(delimiter.length() == 0 || endIndex <= startIndex || startIndex < 0 || startIndex >= source.length()) return new char[0];
        int amount = count(source, delimiter, startIndex, endIndex);
    ...
    public double[] doubleSplit(String source, String delimiter, int startIndex, int endIndex) {
        if(delimiter.length() == 0 || endIndex <= startIndex || startIndex < 0 || startIndex >= source.length()) return new double[0];
        int amount = count(source, delimiter, startIndex, endIndex);
    ...
    public float[] floatSplit(String source, String delimiter, int startIndex, int endIndex) {
        if(delimiter.length() == 0 || endIndex <= startIndex || startIndex < 0 || startIndex >= source.length()) return new float[0];
        int amount = count(source, delimiter, startIndex, endIndex);
    ...
    private <A> A[] split2D(String source, String majorDelimiter, String minorDelimiter, int startIndex, int endIndex, ISplitter<A> fn, A[] dummy){
        ...
        if(endIndex <= startIndex || startIndex < 0 || startIndex >= source.length()) return dummy;
