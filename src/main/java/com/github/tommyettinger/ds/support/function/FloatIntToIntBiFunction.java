...
/**
 * Represents a function that accepts a {@code float} argument and a {@code int}
 * argument, and produces a int-valued result.  This is the {@code (float, int)},
 * {@code int}-producing primitive specialization for {@link BiFunction}.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #applyAsInt(float, int)}.
 *
 * @see BiFunction
 */
@FunctionalInterface
