 ...
 * <br>
 * You can change the iterator, offset, and stride at once using {@link #set(ShortIterator, int, int)}, and can also just
 * change the iterator with {@link #set(ShortIterator)}.
 */
public class StridingShortIterator implements ShortIterator {
    ...
    public StridingShortIterator() {
    }

    public StridingShortIterator(final ShortIterator iterator, int offset, int stride) {
        set(iterator, offset, stride);
    }

    public void set (final ShortIterator iterator, int offset, int stride) {
