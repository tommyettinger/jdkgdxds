...
/**
 * Represents a function that accepts a {@code long} argument and a {@code float}
 * argument, and produces a float-valued result.  This is the {@code (long, float)},
 * {@code float}-producing primitive specialization for {@link BiFunction}.
 *
 * <p>This is a <a href="package-summary.html">functional interface</a>
 * whose functional method is {@link #applyAsFloat(long, float)}.
 *
 * @see BiFunction
 */
@FunctionalInterface
