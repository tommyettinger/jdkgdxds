 ...
 * a {@code double} item to it.
 * This is often a method reference to a method in {@link Base}, such as {@link Base#appendFriendly(CharSequence, double)}.
 */
public interface DoubleAppender {
	 ...
	 * {@link StringBuilder#append(double)} when you want to use that as an DoubleAppender.
	 * This actually calls {@link Base#appendGeneral(CharSequence, double)} on
	 * {@link Base#BASE10}, and works with more than StringBuilder.
	 */
	DoubleAppender DEFAULT = Base.BASE10::appendGeneral;
	 ...
	 */
	DoubleAppender DENSE = DoubleAppender::appendDense;
