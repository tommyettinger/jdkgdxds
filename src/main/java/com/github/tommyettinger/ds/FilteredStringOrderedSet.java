...
public class FilteredStringOrderedSet extends ObjectOrderedSet<String> {
	 ...
	 */
	public FilteredStringOrderedSet (CharPredicate filter, CharToCharFunction editor) {
		super();
		this.filter = filter;
		this.editor = editor;
	}
	 ...
	 * @param loadFactor      what fraction of the capacity can be filled before this has to resize; 0 &lt; loadFactor &lt;= 1
	 */
	public FilteredStringOrderedSet (CharPredicate filter, CharToCharFunction editor, int initialCapacity, float loadFactor) {
		super(initialCapacity, loadFactor);
		this.filter = filter;
		this.editor = editor;
	}
	 ...
	 */
	public FilteredStringOrderedSet (CharPredicate filter, CharToCharFunction editor, Collection<? extends String> coll) {
	 ...
	 */
	public FilteredStringOrderedSet (CharPredicate filter, CharToCharFunction editor, String[] array, int offset, int length) {
	 ...
	 */
	public FilteredStringOrderedSet (CharPredicate filter, CharToCharFunction editor, String[] array) {
	 ...
	 * This uses the specified filter and editor, including while it enters the items in ordered.
	 *
	 * @param filter a CharPredicate that should return true iff a character should be considered for equality/hashing
	 * @param editor a CharToCharFunction that will take a char from a key String and return a potentially different char
	 ...
	 */
	public FilteredStringOrderedSet (CharPredicate filter, CharToCharFunction editor, Ordered<String> ordered, int offset, int count) {
	 ...
	 */
	public FilteredStringOrderedSet setFilter(CharPredicate filter) {
		clear();
		this.filter = filter;
		return this;
	}
	 ...
	 * @return this, for chaining
	 */
	public FilteredStringOrderedSet setEditor(CharToCharFunction editor) {
		clear();
		this.editor = editor;
		return this;
	}
	 ...
	 * @return this, for chaining
	 */
	public FilteredStringOrderedSet setModifiers(CharPredicate filter, CharToCharFunction editor) {
		clear();
		this.filter = filter;
		this.editor = editor;
		return this;
	...
	public static FilteredStringOrderedSet with (CharPredicate filter, CharToCharFunction editor, String item) {
		FilteredStringOrderedSet set = new FilteredStringOrderedSet(filter, editor, 1, Utilities.getDefaultLoadFactor());
		set.add(item);
		return set;
	}

	public static FilteredStringOrderedSet with (CharPredicate filter, CharToCharFunction editor, String... array) {
        return new FilteredStringOrderedSet(filter, editor, array);
	}
