 ...
 * 2.2.8 map gets total collisions: 22962, PILEUP: 6
 * 63100936200 ns taken for 1000 ops
 */
public class CaseInsensitiveIntMap228CollisionTest {
	public static void main(String[] args) throws IOException {
		...
		for (int it = 0; it < 1000; it++) {
			CaseInsensitiveIntMap228 set = new CaseInsensitiveIntMap228(CAPACITY, 0.2f);
