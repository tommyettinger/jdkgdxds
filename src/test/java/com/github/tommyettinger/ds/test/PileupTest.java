	...
	public void testPointSetAngles() {
		...
		IntIntToIntBiFunction[] hashes = {
			...
			((x, y) -> {
				int n = (x >= y ? x * (x + 8) - y + 12 : y * (y + 6) + x + 12);
				return n ^ n >>> 1;
			}), // 1MS strong, 2A strong, 3MA strong
			((x, y) -> {
				int n = (x >= y ? x * (x + 8) - y + 12 : y * (y + 6) + x + 12);
				return ((n ^ n >>> 1) * 0x9E373 ^ 0xD1B54A35) * 0x125493 ^ 0x91E10DA5;
			}), // 1MS strong, 2A strong, 3MA strong
			...
			((x, y) -> {
				int n = (y + ((x + y + 6) * (x + y + 7) >> 1));
				return n ^ n >>> 1;
			}), // 1MS fail 78643/500000, 2A fail 9830/500000, 3MA fail 78643/500000
			((x, y) -> {
				int n = (y + ((x + y + 6) * (x + y + 7) >> 1));
				return ((n ^ n >>> 1) * 0x9E373 ^ 0xD1B54A35) * 0x125493 ^ 0x91E10DA5;
			}), // 1MS fail 78643/500000, 2A fail 78643/500000, 3MA fail 78643/500000
	...
	public void testPointSetSpiral() {
		...
		IntIntToIntBiFunction[] hashes = {
			...
			((x, y) -> {
				int n = (x >= y ? x * (x + 8) - y + 12 : y * (y + 6) + x + 12);
				return n ^ n >>> 1;
			}), // 1MS fail 314572/500000, 2A fail 39321/500000, 3MA fail 314572/500000
			((x, y) -> {
				int n = (x >= y ? x * (x + 8) - y + 12 : y * (y + 6) + x + 12);
				return ((n ^ n >>> 1) * 0x9E373 ^ 0xD1B54A35) * 0x125493 ^ 0x91E10DA5;
			}), // 1MS fail 314572/500000, 2A fail 314572/500000, 3MA fail 314572/500000
			((x, y) -> y + ((x + y + 6) * (x + y + 7) >>> 1)), // 1MS fail 314572/500000, 2A fail 39321/500000, 3MA fail 314572/500000
			((x, y) -> {
				int n = (y + ((x + y + 6) * (x + y + 7) >> 1));
				return n ^ n >>> 1;
			}), // 1MS fail 314572/500000, 2A fail 19660/500000, 3MA fail 314572/500000
			((x, y) -> {
				int n = (y + ((x + y + 6) * (x + y + 7) >> 1));
				return ((n ^ n >>> 1) * 0x9E373 ^ 0xD1B54A35) * 0x125493 ^ 0x91E10DA5;
			}), // 1MS fail 314572/500000, 2A fail 314572/500000, 3MA fail 314572/500000
	...
	public void testPointSetAnglesFull() {
		...
		IntIntToIntBiFunction[] hashes = {
			...
			((x, y) -> {
				int n = (y + ((x + y + 6) * (x + y + 7) >> 1));
				return n ^ n >>> 1;
			}), // hash 7 1MS fail 78643/500000, 2A fail 4915/500000, 3MA fail 78643/500000
			((x, y) -> {
				int n = (y + ((x + y + 6) * (x + y + 7) >> 1));
				return ((n ^ n >>> 1) * 0x9E373 ^ 0xD1B54A35) * 0x125493 ^ 0x91E10DA5;
			}), // hash 8 1MS fail 39321/500000, 2A fail 39321/500000, 3MA fail 39321/500000
	...
	public void testPointSetSpiralFull() {
		...
		IntIntToIntBiFunction[] hashes = {
			...
			((x, y) -> {
				int n = (x >= y ? x * (x + 8) - y + 12 : y * (y + 6) + x + 12);
				return n ^ n >>> 1;
			}), // hash 4 1MS fail 157286/500000, 2A fail 19660/500000, 3MA fail 157286/500000
			((x, y) -> {
				int n = (x >= y ? x * (x + 8) - y + 12 : y * (y + 6) + x + 12);
				return ((n ^ n >>> 1) * 0x9E373 ^ 0xD1B54A35) * 0x125493 ^ 0x91E10DA5;
			}), // hash 5 1MS fail 157286/500000, 2A fail 157286/500000, 3MA fail 157286/500000
			((x, y) -> y + ((x + y + 6) * (x + y + 7) >>> 1)), // hash 6 1MS fail 157286/500000, 2A fail 9830/500000, 3MA fail 157286/500000
			((x, y) -> {
				int n = (y + ((x + y + 6) * (x + y + 7) >> 1));
				return n ^ n >>> 1;
			}), // hash 7 1MS fail 157286/500000, 2A fail 9830/500000, 3MA fail 157286/500000
			((x, y) -> {
				int n = (y + ((x + y + 6) * (x + y + 7) >> 1));
				return ((n ^ n >>> 1) * 0x9E373 ^ 0xD1B54A35) * 0x125493 ^ 0x91E10DA5;
			}), // hash 8 1MS fail 157286/500000, 2A fail 157286/500000, 3MA fail 157286/500000
...
//            return hash;
		...
		@Override
		protected void addResize(String key) {
			Object[] keyTable = this.keyTable;
			for (int i = place(key), p = 0; ; i = i + 1 & mask) {
				if (keyTable[i] == null) {
					keyTable[i] = key;
	...
	static class MeasuredCaseInsensitiveSet extends CaseInsensitiveSet {
		...
		@Override
		protected void addResize(CharSequence key) {
			Object[] keyTable = this.keyTable;
			for (int i = place(key), p = 0; ; i = i + 1 & mask) {
				if (keyTable[i] == null) {
					keyTable[i] = key;
