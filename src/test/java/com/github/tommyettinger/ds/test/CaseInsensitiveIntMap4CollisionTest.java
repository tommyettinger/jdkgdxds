 ...
 * 10800020300 ns taken for 1000 ops
 * <br>
 ...
 * Revision 4 map gets total collisions: 140235, PILEUP: 18
 * 32880819100 ns taken for 1000 ops
 * <br>
 * Using initial capacity 230 and load factor 0.5f...
 * Revision 4 map gets total collisions: 43620, PILEUP: 10
 * 21329109900 ns taken for 1000 ops
 * <br>
 * Using initial capacity 230 and load factor 0.2f...
 * Revision 4 map gets total collisions: 23364, PILEUP: 7
 * 51225758800 ns taken for 1000 ops
 */
public class CaseInsensitiveIntMap4CollisionTest {
	public static void main(String[] args) throws IOException {
		...
		for (int it = 0; it < 1000; it++) {
			CaseInsensitiveIntMap4 set = new CaseInsensitiveIntMap4(CAPACITY, 0.2f);
