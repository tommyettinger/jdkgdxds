 ...
 * With changing enabled, the earlier 256 with another 256 appended known good:
 * 0 problem multipliers in total, 512 likely good multipliers in total.
 * Lowest collisions : 5214503
 * Highest collisions: 5263444
 * Lowest pileup     : 16
 * Highest pileup    : 16
 * With changing disabled, modifying the last set to change 10 multipliers that were unusually slow:
 * 0 problem multipliers in total, 512 likely good multipliers in total.
 * Lowest collisions : 5212370
 * Highest collisions: 5379959
 * Lowest pileup     : 16
 * Highest pileup    : 16
 */
...
//		};
		...
		// has 512 int multipliers, each using 21 bits or fewer.
		// modified to avoid the worst-performing multipliers.
		// 0x0001A649, 0x0000D339, 0x0000C2E5, 0x0000CC3D, 0x000170D3, 0x000179E3, 0x000186F9, 0x00138427, 0x001DD2B7, 0x001F85C7
		// were replaced with
		// 0x001BF8EF, 0x0001187B, 0x000BC405, 0x000B0F29, 0x0007FFA5, 0x0015987B, 0x000ED595, 0x000578EF, 0x00093535, 0x00188E55
		final int[] GOOD = new int[]{
...
//							good.remove(g);
					...
					public void clear () {
						...
						System.out.println(" gets total collisions: " + collisionTotal + ", PILEUP: " + good.get(g) + ", TIME: " + (System.nanoTime() - time));
