...
import com.github.tommyettinger.textra.utils.CaseInsensitiveIntMap2;
 ...
 * 11704833400 ns taken for 1000 ops
 * <br>
 * Using initial capacity 58992 and load factor 0.6f...
 * Revision 2 map gets total collisions: 50668, PILEUP: 14
 * 27034140100 ns taken for 1000 ops
 * <br>
 * Using initial capacity 230 and load factor 0.6f...
 * Revision 2 map gets total collisions: 67341, PILEUP: 14
 * 29811012100 ns taken for 1000 ops
 * <br>
 * Using initial capacity 230 and load factor 0.8f...
 * Revision 2 map gets total collisions: 138047, PILEUP: 23
 * 36642943200 ns taken for 1000 ops
 * <br>
 * Using initial capacity 230 and load factor 0.5f...
 * Revision 2 map gets total collisions: 43705, PILEUP: 11
 * 24878258700 ns taken for 1000 ops
 * <br>
 * Using initial capacity 230 and load factor 0.2f...
 * Revision 2 map gets total collisions: 23533, PILEUP: 7
 * 65073889900 ns taken for 1000 ops
 */
public class CaseInsensitiveIntMap2CollisionTest {
	public static void main(String[] args) throws IOException {
		...
		for (int it = 0; it < 1000; it++) {
			CaseInsensitiveIntMap2 set = new CaseInsensitiveIntMap2(CAPACITY, 0.2f);
