...
public class CaseInsensitiveIntMap5 implements Iterable<CaseInsensitiveIntMap5.Entry> {
	public int size;
	...
	public CaseInsensitiveIntMap5() {
		this(51, 0.6f);
	}

	/** Creates a new map with a load factor of 0.6 .
	 * @param initialCapacity The backing array size is initialCapacity / loadFactor, increased to the next power of two. */
	public CaseInsensitiveIntMap5(int initialCapacity) {
	 ...
	 * @param initialCapacity The backing array size is initialCapacity / loadFactor, increased to the next power of two. */
	public CaseInsensitiveIntMap5(int initialCapacity, float loadFactor) {
	 ...
	 * 0.6 . */
	public CaseInsensitiveIntMap5(String[] keys, int[] values) {
	...
	public CaseInsensitiveIntMap5(CaseInsensitiveIntMap5 map) {
	...
	public void putAll (CaseInsensitiveIntMap5 map) {
...
//		longestPileup = 0;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof CaseInsensitiveIntMap5)) return false;
		CaseInsensitiveIntMap5 other = (CaseInsensitiveIntMap5)obj;
	...
	private static class MapIterator {
		...
		final CaseInsensitiveIntMap5 map;
		int nextIndex, currentIndex;
		boolean valid = true;

		public MapIterator (CaseInsensitiveIntMap5 map) {
			this.map = map;
			reset();
		}
	...
	public static class Entries extends MapIterator implements Iterable<Entry>, Iterator<Entry> {
		...
		public Entries (CaseInsensitiveIntMap5 map) {
			super(map);
		}
	...
	public static class Values extends MapIterator {
		public Values (CaseInsensitiveIntMap5 map) {
			super(map);
		}
	...
	public static class Keys extends MapIterator implements Iterable<String>, Iterator<String> {
		public Keys (CaseInsensitiveIntMap5 map) {
			super(map);
		}
	...
	/**
	 * Speck cipher run on two chars at a time. This gets the hash as if all cased letters have
	 * been converted to upper case by {@link Category#caseUp(char)}; this should be correct for all alphabets in
	 * Unicode except Georgian. Typically, place() methods in Sets and Maps here that want case-insensitive hashing
	...
	public static int hashCodeIgnoreCase (final CharSequence data, int seed) {
		...
		for (int p = 1; p < len; p+=2) {
			b=(b<< 3|b>>>29)^(a=(a<<24|a>>> 8)+b^Category.caseUp(data.charAt(p-1)))+(a<< 7|a>>>25);
			a=(a<<14|a>>>18)^(b=(b<<29|b>>> 3)+a^Category.caseUp(data.charAt(p)))+(b<<11|b>>>21);
		}
		if((len & 1) == 1)
			a=(a<<10|a>>>22)^(b=(b<<25|b>>> 7)+a^Category.caseUp(data.charAt(len-1)))+(b<<19|b>>>13);
