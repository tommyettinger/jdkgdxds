...
public class CaseInsensitiveIntMap4 implements Iterable<CaseInsensitiveIntMap4.Entry> {
	public int size;
	...
	public CaseInsensitiveIntMap4() {
		this(51, 0.6f);
	}

	/** Creates a new map with a load factor of 0.6 .
	 * @param initialCapacity The backing array size is initialCapacity / loadFactor, increased to the next power of two. */
	public CaseInsensitiveIntMap4(int initialCapacity) {
	 ...
	 * @param initialCapacity The backing array size is initialCapacity / loadFactor, increased to the next power of two. */
	public CaseInsensitiveIntMap4(int initialCapacity, float loadFactor) {
	 ...
	 * 0.6 . */
	public CaseInsensitiveIntMap4(String[] keys, int[] values) {
	...
	public CaseInsensitiveIntMap4(CaseInsensitiveIntMap4 map) {
	...
	public void putAll (CaseInsensitiveIntMap4 map) {
	...
	public void clear () {
		System.out.println("Revision 4 map gets total collisions: " + collisionTotal + ", PILEUP: " + longestPileup);
...
//		longestPileup = 0;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof CaseInsensitiveIntMap4)) return false;
		CaseInsensitiveIntMap4 other = (CaseInsensitiveIntMap4)obj;
	...
	private static class MapIterator {
		...
		final CaseInsensitiveIntMap4 map;
		int nextIndex, currentIndex;
		boolean valid = true;

		public MapIterator (CaseInsensitiveIntMap4 map) {
			this.map = map;
			reset();
		}
	...
	public static class Entries extends MapIterator implements Iterable<Entry>, Iterator<Entry> {
		...
		public Entries (CaseInsensitiveIntMap4 map) {
			super(map);
		}
	...
	public static class Values extends MapIterator {
		public Values (CaseInsensitiveIntMap4 map) {
			super(map);
		}
	...
	public static class Keys extends MapIterator implements Iterable<String>, Iterator<String> {
		public Keys (CaseInsensitiveIntMap4 map) {
			super(map);
		}
	...
	public static int hashCodeIgnoreCase (final CharSequence data, int seed) {
		...
		for (int p = 1; p < len; p+=2) {
			seed = Compatibility.imul(m ^ Category.caseUp(data.charAt(p-1)) << 8, seed + Category.caseUp(data.charAt(p)));
		}
		if((len & 1) == 1)
			seed ^= Category.caseUp(data.charAt(len-1));
