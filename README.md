...
```
api "com.github.tommyettinger:jdkgdxds:1.10.1"
```
...
version for the `digital` dependency is 0.7.0 (you can specify it manually with the core dependency
`api "com.github.tommyettinger:digital:0.7.0"`). Funderby has only changed a bit since its initial release, and is on version
...
implementation "com.github.tommyettinger:jdkgdxds:1.10.1:sources"
```
to its
