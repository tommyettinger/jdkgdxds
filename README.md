...
```
api 'com.github.tommyettinger:jdkgdxds:1.4.3'
```
...
version for the `digital` dependency is 0.4.2 (you can specify it manually with the core dependency
`api "com.github.tommyettinger:digital:0.4.2"`). Funderby has only changed a bit since its initial release, and is on version
